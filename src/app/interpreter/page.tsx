export default function InterpreterPage() {
  return (
    <div>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          A Cosmo program consists of a series of <em>declarations</em>.
          Declarations include variables, functions, and statements. Programs are structured
          using blocks, which are enclosed in curly braces <span className="font-mono">{'{}'}</span>.
        </p>
      ...
      <section className="mb-8">
        ...
        <ul className="list-inside space-y-4">
          ...
          <li>
            ...
            <p>
              Functions are defined using the <span className="font-mono">func</span> keyword, followed by the name,
              optional parameters inside parentheses, and a block of code.
            </p>
            <div className="mt-2">
              <p className="font-semibold">Example:</p>
              <pre className="bg-gray-100 dark:bg-gray-800 p-4 rounded overflow-x-auto">
  ...
  output("Hello " + name);
          ...
          <li>
            ...
            <p>These include expressions, control flow statements (like if, while, for), and output/return blocks.</p>
          </li>
        </ul>
  ...
  output(a);
      ...
      <section className="mb-8">
        ...
        <ul className="list-inside space-y-4">
          ...
          <li>
            ...
            <p>
              - Use <span className="font-mono">or</span>, <span className="font-mono">and</span> for combining boolean expressions.
              <br />
              - Use <span className="font-mono">{'!'}</span> or <span className="font-mono">not</span> for negation.
            </p>
            <pre className="bg-gray-100 dark:bg-gray-800 p-4 rounded overflow-x-auto">
          ...
          <li>
            ...
            <p>
              - Use <span className="font-mono">==</span>, <span className="font-mono">!=</span>, <span className="font-mono">{'>'}</span>, <span className="font-mono">{'>='}</span>, <span className="font-mono">{'<'}</span>, and <span className="font-mono">{'<='}</span>.
            </p>
            <pre className="bg-gray-100 dark:bg-gray-800 p-4 rounded overflow-x-auto">
              <code>{`if (x != y) { ... }`}</code>
            </pre>
          ...
          <li>
            ...
            <p>
              - Use <span className="font-mono">+</span>, <span className="font-mono">-</span>, <span className="font-mono">*</span>, <span className="font-mono">/</span>, and <span className="font-mono">%</span>.
            </p>
            <pre className="bg-gray-100 dark:bg-gray-800 p-4 rounded overflow-x-auto">
          ...
          <li>
            ...
            <p>
              - Use <span className="font-mono">-x</span>, <span className="font-mono">!x</span>, or <span className="font-mono">not x</span>.
            </p>
            <pre className="bg-gray-100 dark:bg-gray-800 p-4 rounded overflow-x-auto">
              <code>{`x = -y;`}</code>
            </pre>
          ...
          <li>
            ...
            <p>
              These include variables, literals (numbers, strings), booleans, nulls, or grouped expressions in parentheses.
            </p>
            <pre className="bg-gray-100 dark:bg-gray-800 p-4 rounded overflow-x-auto">
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside space-y-2">
          <li>
            <strong>Identifiers:</strong> Names for variables/functions. They start with a letter or underscore.
          </li>
          <li>
          ...
          <li>
            <strong>Booleans:</strong> Use <span className="font-mono">true</span> or <span className="font-mono">false</span>.
          </li>
          <li>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          These functions are globally available for use in your Cosmo programs.
        </p>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p>
              <strong>Errors:</strong> Throws if either <span className="font-mono">a</span> or <span className="font-mono">b</span> is not a number.
            </p>
            <p>
...
output(result); // Outputs: 22.5`}</code>
          ...
          <div>
            ...
            <p>
              <strong>Errors:</strong> Throws if <span className="font-mono">x</span> is not a number or is negative.
            </p>
            <p>
              <strong>Example:</strong>
            </p>
...
output(short); // Outputs: "Cosmo"`}</code>
          ...
          <div>
            ...
            <p>
              <strong>Errors:</strong> Throws if <span className="font-mono">value</span> is neither a string nor a list.
            </p>
            <p>
              <strong>Example:</strong>
            </p>
...
output(len); // Outputs: 5`}</code>
          ...
          <div>
            ...
            <p>
              <strong>Purpose:</strong> Returns the type of a value as a string (e.g., "Number", "String").
            </p>
            <p>
              <strong>Returns:</strong> A string.
            </p>

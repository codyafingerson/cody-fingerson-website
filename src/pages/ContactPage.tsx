        ...
        >
            ...
            <form className="space-y-4" action="https://getform.io/f/bqokzpmb" method="POST">
                ...
                <div className="flex justify-between">
                    <button
                        type="submit"
                        className="w-1/2 py-3 bg-blue-500 dark:bg-blue-600 hover:bg-blue-600 dark:hover:bg-blue-700 text-white transition cursor-pointer mr-2 rounded"
                    >
                        Send Message
                    </button>
                    <button
                        type="reset"
                        className="w-1/2 py-3 bg-gray-400 dark:bg-gray-500 hover:bg-gray-500 dark:hover:bg-gray-600 text-white transition cursor-pointer rounded"
                    >
                        Clear
                    </button>
                </div>
